...
const config = {
       apiKey: "AIzaSyBQB-10lMBkbo5uAaYZi-eOGSFYFN70vAQ",
  authDomain: "medidores-cerralvo.firebaseapp.com",
  databaseURL: "https://medidores-cerralvo.firebaseio.com",
  projectId: "medidores-cerralvo",
  storageBucket: "medidores-cerralvo.appspot.com",
  messagingSenderId: "729979216091",
  appId: "1:729979216091:web:73a481782de786381fecfe",
  measurementId: "G-326TK0QX4K"
...
var deltaLat;
var deltaLng;
var position = [25.69915356, -99.62347808]; //lat lon CEID
...
function initMap() { // Google Map Initialization... 
    map = new google.maps.Map(document.getElementById('map'), {
        zoom: 16,
        center: new google.maps.LatLng(25.69915356, -99.62347808),
...
var cars_Ref = firebase.database().ref('/LAMPARAS_E2CVO');


var dataConductores = firebase.database().ref('/LAMPARAS_E2CVO');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E2CVO');
